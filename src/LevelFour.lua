...
LevelFour = Gamestate.new()

function LevelFour:enter(prev)
  ...
  block1 = {}
  block1.body = love.physics.newBody(world, 250, 550, "dynamic")
  ...
  block2 = {}
  block2.body = love.physics.newBody(world, 250, 400, "dynamic")
  ...
  block3 = {}
  block3.body = love.physics.newBody(world, 400, 400, "dynamic")
  block3.shape = love.physics.newRectangleShape(0, 0, 100, 50)
  block3.fixture = love.physics.newFixture(block3.body, block3.shape, 3)
  block3.fixture:setRestitution(0.1)
  table.insert(objects, block3)

  triangle1 = {}
  triangle1.body = love.physics.newBody(world, 550, 450, "dynamic")
  triangle1.shape = love.physics.newPolygonShape( -25, 25, -25, -75, 75, 25)
  triangle1.fixture = love.physics.newFixture(triangle1.body, triangle1.shape, 3)
  triangle1.fixture:setRestitution(0.1)
  table.insert(objects, triangle1)

  triangle2 = {}
  triangle2.body = love.physics.newBody(world, 150, 450, "dynamic")
  triangle2.shape = love.physics.newPolygonShape( 25, 25, 25, -75, -75, 25)
  triangle2.fixture = love.physics.newFixture(triangle2.body, triangle2.shape, 3)
  triangle2.fixture:setRestitution(0.1)
  table.insert(objects, triangle2)
